                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-category-blog')}}">Thêm thể loại bài viết</a></li>
                                <li><a href="{{URL::to('/all-category-blog')}}">Liệt kê thể loại bài viết</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                        ...
                        <li class="sub-menu" style="display:<?php
                            $name = Session::get('admin_status');
                            if ($name) {
                             echo $name;
                         }
                         ?>;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-user')}}">Thêm nhân viên</a></li>
                                <li><a href="{{URL::to('/all-user')}}">List nhân viên</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu" style="display:<?php
                            $name = Session::get('admin_status');
                         ...
                         ?>;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/all-customer')}}">List thành viên</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu" style="display:<?php
                            $name = Session::get('admin_status');
                         ...
                         ?>;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-spam')}}">Thêm Spam Text</a></li>
                                <li><a href="{{URL::to('/all-spam')}}">List Spam</a></li>
                                <li><a href="{{URL::to('/all-spam-comment')}}">List Comment Spam</a></li>
                            </ul>
                        </li>
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>© 2024 Tạ Quang Sơn. All rights reserved |Cổng Thông tin điện tử</a></p>
                </div>
            </div>
            <!-- / footer -->
        </section>
